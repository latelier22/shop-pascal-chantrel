...
Encore
  .setOutputPath('public/marcel-sejour-theme/')
  .setPublicPath('/marcel-sejour-theme')
  .addEntry('shop-marcel', './themes/MarcelSejourTheme/assets/entry.js')
  .copyFiles({
    from: './themes/MarcelSejourTheme/assets/images',
...
const marcelsejourThemeConfig = Encore.getWebpackConfig();
marcelsejourThemeConfig.name = 'shop-marcel';
...
// module.exports = [shopConfig, adminConfig, appShopConfig, appAdminConfig, marcelsejourThemeConfig];
