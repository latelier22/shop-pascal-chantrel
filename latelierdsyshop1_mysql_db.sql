...
--
-- Hôte : latelierdsyshop1.mysql.db
-- Généré le : lun. 08 jan. 2024 à 15:53
...
--
-- Base de données : `latelierdsyshop1`
--
CREATE DATABASE IF NOT EXISTS `sylius_shop1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sylius_shop1`;
