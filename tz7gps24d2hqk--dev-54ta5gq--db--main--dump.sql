...
INSERT INTO `sylius_tax_category` VALUES (1,'TVA20','TVA à 20%','TVA à 20% applicable','2024-01-04 13:33:27','2024-01-04 13:33:27');
...
INSERT INTO `sylius_taxon_translation` VALUES (1,1,'radio car','radio-car',NULL,'en_US'),(2,1,'Véhicules radio-commandés','vehicules-radio-commandes',NULL,'fr'),(3,1,'Véhicules radio-commandés','vehicules-radio-commandes','Acheter votre véhicule pour faire des balades avec ou organiser des courses\r\nentre ami(e)s.','fr_FR'),(4,2,'Presents','presents',NULL,'en_US'),(5,2,'Cadeaux','cadeaux',NULL,'fr'),(6,2,'Cadeaux','cadeaux','Faîtes le plein d\'idées cadeaux personnalisés','fr_FR'),(7,3,'Category','category',NULL,'en_US'),(8,3,'Categorie','categorie',NULL,'fr'),(9,3,'Categorie','categorie',NULL,'fr_FR');
